...
-- Loading data from partisanship-small.txt into Partisanship
LOAD DATA LOCAL INFILE './input-text-files/partisanship-small.txt'
...
-- Loading data from trafficstatistics-small.txt into TrafficStatistics
LOAD DATA LOCAL INFILE './input-text-files/trafficstatistics-small.txt'
...
-- Loading data from stop-small.txt into Stop
LOAD DATA LOCAL INFILE './input-text-files/stop-small.txt'
INTO TABLE Stop
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n';
...
LOAD DATA LOCAL INFILE './input-text-files/driver-small.txt'
INTO TABLE Driver
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n';
